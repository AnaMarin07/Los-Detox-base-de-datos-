...
<head>
    <meta charset="UTF-8">
    <title>Detox Project - Unisex </title>
...
<body>
    ...
    <div style="padding: 60px 20px; text-align: center; background-color: #fcfcfc;">
        <h1 style="font-size: 45px; font-weight: 900; letter-spacing: -2px; margin-bottom: 10px; text-transform: uppercase;">Unisex</h1>
        <p style="color: #888; margin-bottom: 40px;">Colección exclusiva para todos!!!</p>
